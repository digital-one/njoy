<main class="product-selector">
  ...
  <div class="product-selector__sections">
    <div class="product-selector__bundle">
      <img alt="Load in" class="product-selector__bundle__img" src="<?php echo get_template_directory_uri(); ?>/assets/artists/lineup/load-in-1275f2e364ef08bd94c65ea1fc37bf0c.png" />
    </div>
  </div><!--

  --><div class="product-selector__sections product-selector__sections--secondary">
    ...
    <div class="product-selector__buy">
      <form accept-charset="UTF-8" action="/cart/add" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="dWioppEn1hG72YLYkeffucGsJzgqXn5z3ucNfdCMlsU=" /></div><input id="quantity" name="quantity" type="hidden" value="1" /><input id="variant_id" name="variant_id" type="hidden" value="638" /><button class="product-variants__add-to-cart" data-hook="add-bundle-to-cart" name="button" type="submit">Add to cart</button></form>
    </div>
  </div>
</article>
    ...
    <div class="product-selector__buy">
      <form accept-charset="UTF-8" action="/cart/add" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="dWioppEn1hG72YLYkeffucGsJzgqXn5z3ucNfdCMlsU=" /></div><input id="quantity" name="quantity" type="hidden" value="1" /><input id="variant_id" name="variant_id" type="hidden" value="636" /><button class="product-variants__add-to-cart" data-hook="add-bundle-to-cart" name="button" type="submit">Add to cart</button></form>
        ...
        <article class="product-selector__product
          ...
          <div class="product-selector__sections">
            <div class="product-selector__image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/artists/narrow/sacre-coeur-01f68284f591e610511887ccd315f6f2.jpg)">
              <a class="product-selector__link" href="/artistcollection/sacre-coeur">
                <img alt="Sacre coeur" class="product-selector__bottle" src="<?php echo get_template_directory_uri(); ?>/assets/artists/bottles/sacre-coeur-8695624d7feec25593e111bd5a9eea70.png" />
</a>            </div>
  ...
  <form accept-charset="UTF-8" action="/cart/add" data-hook="add-to-cart" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="dWioppEn1hG72YLYkeffucGsJzgqXn5z3ucNfdCMlsU=" /></div>
    ...
    <button class="product-variants__add-to-cart" name="button" type="submit">Add to cart</button>
        ...
        <article class="product-selector__product
          ...
          <div class="product-selector__sections">
            <div class="product-selector__image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/artists/narrow/dragonscape-04569192769ab3bfe4df776769e91201.jpg)">
              <a class="product-selector__link" href="/artistcollection/dragonscape">
                <img alt="Dragonscape" class="product-selector__bottle" src="<?php echo get_template_directory_uri(); ?>/assets/artists/bottles/dragonscape-19cc242c22c9fee1a0f7e9a7bbb6f15f.png" />
</a>            </div>
  ...
  <form accept-charset="UTF-8" action="/cart/add" data-hook="add-to-cart" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="dWioppEn1hG72YLYkeffucGsJzgqXn5z3ucNfdCMlsU=" /></div>
    ...
    <button class="product-variants__add-to-cart" name="button" type="submit">Add to cart</button>
        ...
        <article class="product-selector__product
          ...
          <div class="product-selector__sections">
            <div class="product-selector__image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/artists/narrow/hedons-bite-5c9f232858e3fec1c4bad7bee5fca757.jpg)">
              <a class="product-selector__link" href="/artistcollection/hedons-bite">
                <img alt="Hedons bite" class="product-selector__bottle" src="<?php echo get_template_directory_uri(); ?>/assets/artists/bottles/hedons-bite-bfbd9e4eee712be5fa673fe12cecf5ec.png" />
</a>            </div>
  ...
  <form accept-charset="UTF-8" action="/cart/add" data-hook="add-to-cart" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="dWioppEn1hG72YLYkeffucGsJzgqXn5z3ucNfdCMlsU=" /></div>
    ...
    <button class="product-variants__add-to-cart" name="button" type="submit">Add to cart</button>
        ...
        <article class="product-selector__product
          ...
          <div class="product-selector__sections">
            <div class="product-selector__image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/artists/narrow/paramour-6ba806b6db5f87358eae8ce58d5aedbd.jpg)">
              <a class="product-selector__link" href="/artistcollection/paramour">
                <img alt="Paramour" class="product-selector__bottle" src="<?php echo get_template_directory_uri(); ?>/assets/artists/bottles/paramour-17826bafa9f97125bb48c8e44fe3f3ce.png" />
</a>            </div>
  ...
  <form accept-charset="UTF-8" action="/cart/add" data-hook="add-to-cart" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="dWioppEn1hG72YLYkeffucGsJzgqXn5z3ucNfdCMlsU=" /></div>
    ...
    <button class="product-variants__add-to-cart" name="button" type="submit">Add to cart</button>
        ...
        <article class="product-selector__product
          ...
          <div class="product-selector__sections">
            <div class="product-selector__image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/artists/narrow/samba-sun-4c7d0320c803a8115bd91ee017c08a1a.jpg)">
              <a class="product-selector__link" href="/artistcollection/samba-sun">
                <img alt="Samba sun" class="product-selector__bottle" src="<?php echo get_template_directory_uri(); ?>/assets/artists/bottles/samba-sun-a9ad2c3a57d9872b21af47c86df868f9.png" />
</a>            </div>
